...
class AppColors {
  ...
  ///   800: #FFBD1919
  ///   900: #FFB20F0F
  MaterialColor get crimson_red => const MaterialColor(
        0xFFCF2A2A,
        <int, Color>{
          50: Color(0xFFF9E5E5),
  ...
  ///   800: #FFD27817
  ///   900: #FFCA670E
  MaterialColor get yellow_ocher => const MaterialColor(
        0xFFDF9527,
        <int, Color>{
          50: Color(0xFFFBF2E5),
  ...
  ///   400: #FFFFA989
  ///   700: #FFFF9E7A
  MaterialAccentColor get yellow_ocherAccent => const MaterialAccentColor(
        0xFFFFBCA3,
        <int, Color>{
